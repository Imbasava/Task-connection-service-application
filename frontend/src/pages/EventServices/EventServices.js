...
function EventServices() {
  ...
  const subServices = [
    { id: 1, name: 'Event Planning', description: 'Comprehensive event planning services.' },
    { id: 2, name: 'Photography', description: 'Professional photography for events.' },
    { id: 3, name: 'Catering', description: 'Catering services for all kinds of events.' }
  ];
